  ...
  return (
    <div className="max-w-4xl mx-auto pb-24 md:pb-8">
      ...
      {!summary && !isGenerating && (
        ...
        >
          <div className="bg-indigo-100 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
            <ICONS.Sparkles className="text-indigo-600 w-8 h-8 md:w-10 md:h-10" />
          </div>
